...
public class CharacterController : MonoBehaviour {
    ...
    public class InputSettings
    {
        ...
        public string MOUSE_TURN_AXIS = "Fire2";
    ...
    Rigidbody rBody;
    float forwardInput, turnInput, jumpInput, mouseTurnInput;
    ...
    void Start()
    {
        ...
        forwardInput = turnInput = jumpInput = mouseTurnInput = 0;
    }
    ...
    void GetInput()
    {
        ...
        mouseTurnInput = Input.GetAxisRaw(inputSetting.MOUSE_TURN_AXIS); //not interpolated
    ...
    void Strafe()
    {
        ...
        {
            //move
            velocity.x = Mathf.Lerp(velocity.x, moveSetting.forwardVel * turnInput, moveSetting.forwardVel * Time.deltaTime);
        }
        else
            //zero velocity
            velocity.x = 0;
